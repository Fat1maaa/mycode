...
function updateTotal(moneyChange) {
  ...
  if (totalAmount > 1) {
    total.innerHTML = `<span class="span-primary">Ümumi Məbləğ:</span> $${totalAmount.toFixed(
      2
    )}`;
  } else {
    total.innerHTML = `<br>
      ...
      Add items to cart by hovering over / tapping on the images of products on the Menu page.`;
  }
}
...
function initializeItem1() {
  ...
  <img src="./assets/img/caffe-americano.jpg" alt="product" />
    <div>
...
function initializeItem2() {
  ...
  <img src="./assets/img/caffe-misto.jpg" alt="product" />
    <div>
...
function initializeItem4() {
  ...
  <img src="./assets/img/dark-roast-coffee.jpg" alt="product" />
    <div>
...
function initializeItem8() {
  ...
  <img src="./assets/img/cappuccino.jpg" alt="product" />
    <div>
...
function initializeItem10() {
  ...
  <img src="./assets/img/espresso.jpg" alt="product" />
    <div>
...
function initializeItem11() {
  ...
  <img src="./assets/img/espresso-macchiato.jpg" alt="product" />
    <div>
...
function initializeItem12() {
  ...
  <img src="./assets/img/flat-white.jpg" alt="product" />
    <div>
